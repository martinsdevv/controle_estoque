 ...
 * @author Shai Almog
 */
public class ControleEstoqueStub implements Runnable, WindowListener {
    private static final String APP_TITLE = "Hi World";
    private static final String APP_NAME = "ControleEstoque";
    ...
    private ControleEstoque mainApp;
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(new ControleEstoqueStub());
    }
